...
openssl_md_meth_names = None # (!) real value is "frozenset({'sha3-512', 'sha512-256', 'blake2s256', 'sha512', 'md5', 'sm3', 'md5-sha1', 'md4', 'shake128', 'sha384', 'sha3-256', 'sha3-384', 'sha224', 'whirlpool', 'sha3-224', 'sha1', 'blake2b512', 'sha512-224', 'sha256', 'shake256', 'ripemd160'})"

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f33940951d0>'

__spec__ = None # (!) real value is "ModuleSpec(name='_hashlib', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f33940951d0>, origin='/usr/lib/python3.6/lib-dynload/_hashlib.cpython-36m-x86_64-linux-gnu.so')"
