...
# from /usr/lib/python3/dist-packages/zmq/backend/cython/_device.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f3390fc97b8>'

__spec__ = None # (!) real value is "ModuleSpec(name='zmq.backend.cython._device', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f3390fc97b8>, origin='/usr/lib/python3/dist-packages/zmq/backend/cython/_device.cpython-36m-x86_64-linux-gnu.so')"
