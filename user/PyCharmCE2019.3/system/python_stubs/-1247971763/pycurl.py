# encoding: utf-8
# module pycurl
# from /usr/lib/python3/dist-packages/pycurl.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
"""
...
COMPILE_LIBCURL_VERSION_NUM = 473600

COMPILE_PY_VERSION_HEX = 50726128
...
version = 'PycURL/7.43.0.1 libcurl/7.58.0 GnuTLS/3.5.18 zlib/1.2.11 libidn2/2.0.4 libpsl/0.19.1 (+libidn2/2.0.4) nghttp2/1.30.0 librtmp/2.3'
...
__spec__ = None # (!) real value is "ModuleSpec(name='pycurl', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f339411c7f0>, origin='/usr/lib/python3/dist-packages/pycurl.cpython-36m-x86_64-linux-gnu.so')"
