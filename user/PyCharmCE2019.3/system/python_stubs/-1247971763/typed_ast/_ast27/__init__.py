...
__spec__ = None # (!) real value is "ModuleSpec(name='typed_ast._ast27', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f3394146780>, origin='/usr/local/lib/python3.6/dist-packages/typed_ast/_ast27.cpython-36m-x86_64-linux-gnu.so')"
