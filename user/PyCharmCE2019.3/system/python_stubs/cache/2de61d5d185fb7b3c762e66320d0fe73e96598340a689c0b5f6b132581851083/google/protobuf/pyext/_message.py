...
class Message(object):
    ...
    DESCRIPTOR = None
    _extensions_by_name = mappingproxy({})
    _extensions_by_number = mappingproxy({})
    __hash__ = None
...
default_pool = None # (!) real value is '<google.protobuf.pyext._message.DescriptorPool object at 0x7f339276bd70>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f339411ce48>'

__spec__ = None # (!) real value is "ModuleSpec(name='google.protobuf.pyext._message', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f339411ce48>, origin='/usr/lib/python3/dist-packages/google/protobuf/pyext/_message.cpython-36m-x86_64-linux-gnu.so')"
