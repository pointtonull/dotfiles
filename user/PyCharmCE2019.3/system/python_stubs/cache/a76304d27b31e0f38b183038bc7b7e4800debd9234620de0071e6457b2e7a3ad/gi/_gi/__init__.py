...
TYPE_GSTRING = None # (!) real value is '<GType GString (19364480)>'

TYPE_INVALID = None # (!) real value is '<GType invalid (0)>'

_API = None # (!) real value is '<capsule object "gi._API" at 0x7f339412ebd0>'

_PyGObject_API = None # (!) real value is '<capsule object "gobject._PyGObject_API" at 0x7f339412eb70>'

__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f33930bfcc0>'

__spec__ = None # (!) real value is "ModuleSpec(name='gi._gi', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f33930bfcc0>, origin='/usr/lib/python3/dist-packages/gi/_gi.cpython-36m-x86_64-linux-gnu.so')"
