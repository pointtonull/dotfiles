...
# from /usr/lib/python3/dist-packages/zmq/backend/cython/utils.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
""" 0MQ utils. """
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f3390fc9438>'

__spec__ = None # (!) real value is "ModuleSpec(name='zmq.backend.cython.utils', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f3390fc9438>, origin='/usr/lib/python3/dist-packages/zmq/backend/cython/utils.cpython-36m-x86_64-linux-gnu.so')"
