# encoding: utf-8
# module PyQt5.QtHelp
# from /usr/lib/python3/dist-packages/PyQt5/QtHelp.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
...
class QHelpSearchEngine(__PyQt5_QtCore.QObject):
    ...
    def searchResults(self, p_int, p_int_1): # real signature unknown; restored from __doc__
        """ searchResults(self, int, int) -> object """
        return object()
...
class QHelpSearchResult(): # skipped bases: <class 'sip.simplewrapper'>
    """
    QHelpSearchResult()
