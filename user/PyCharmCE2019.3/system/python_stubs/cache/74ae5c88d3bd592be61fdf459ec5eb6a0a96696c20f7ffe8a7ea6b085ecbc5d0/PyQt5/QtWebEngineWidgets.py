...
# from /usr/lib/python3/dist-packages/PyQt5/QtWebEngineWidgets.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
...
class QWebEngineCertificateError(): # skipped bases: <class 'sip.simplewrapper'>
    # no doc
...
class QWebEngineContextMenuData(): # skipped bases: <class 'sip.simplewrapper'>
    """
...
class QWebEngineFullScreenRequest(): # skipped bases: <class 'sip.simplewrapper'>
...
class QWebEngineHistory(): # skipped bases: <class 'sip.simplewrapper'>
    # no doc
...
class QWebEngineHistoryItem(): # skipped bases: <class 'sip.simplewrapper'>
...
class QWebEnginePage(__PyQt5_QtCore.QObject):
    ...
    def findText(self, p_str, options=0, resultCallback, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ findText(self, str, options: QWebEnginePage.FindFlags = 0, resultCallback: Callable[..., None] = 0) """
        pass
...
class QWebEngineScript(): # skipped bases: <class 'sip.simplewrapper'>
    """
    QWebEngineScript()
...
class QWebEngineScriptCollection(): # skipped bases: <class 'sip.simplewrapper'>
    # no doc
    def clear(self): # real signature unknown; restored from __doc__
        """ clear(self) """
        pass
...
class QWebEngineSettings(): # skipped bases: <class 'sip.simplewrapper'>
    # no doc
