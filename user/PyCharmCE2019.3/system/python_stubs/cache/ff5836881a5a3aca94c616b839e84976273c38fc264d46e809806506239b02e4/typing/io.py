...
# Error generating skeleton for function __exit__: Function has keyword-only parameters or annotations, use getfullargspec() API which can support them
    ...
    _abc_cache = None # (!) real value is '<_weakrefset.WeakSet object at 0x7fadf59102b0>'
    _abc_generic_negative_cache = None # (!) real value is '<_weakrefset.WeakSet object at 0x7fadf59104a8>'
    _abc_generic_negative_cache_version = 35
    _abc_registry = None # (!) real value is '<_weakrefset.WeakSet object at 0x7fadf5910278>'
    ...
    __slots__ = ()
    __tree_hash__ = -9223372036852819029
...
# Error generating skeleton for function __enter__: Function has keyword-only parameters or annotations, use getfullargspec() API which can support them
    ...
    _abc_cache = None # (!) real value is '<_weakrefset.WeakSet object at 0x7fadf5910710>'
    _abc_generic_negative_cache = None # (!) real value is '<_weakrefset.WeakSet object at 0x7fadf5910748>'
    _abc_generic_negative_cache_version = 35
    _abc_registry = None # (!) real value is '<_weakrefset.WeakSet object at 0x7fadf59106d8>'
    ...
    __parameters__ = ()
    __slots__ = ()
    __tree_hash__ = -9223372036852819169
...
# Error generating skeleton for function __enter__: Function has keyword-only parameters or annotations, use getfullargspec() API which can support them
    ...
    _abc_cache = None # (!) real value is '<_weakrefset.WeakSet object at 0x7fadf5910978>'
    _abc_generic_negative_cache = None # (!) real value is '<_weakrefset.WeakSet object at 0x7fadf59109b0>'
    _abc_generic_negative_cache_version = 35
    _abc_registry = None # (!) real value is '<_weakrefset.WeakSet object at 0x7fadf5910940>'
    ...
    __parameters__ = ()
    __slots__ = ()
    __tree_hash__ = -9223372036852818642
