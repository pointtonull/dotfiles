...
# from /usr/lib/python3/dist-packages/zmq/backend/cython/context.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
""" 0MQ Context class. """
...
class Context(object):
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x7f339412ee40>'
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f3390fbf278>'

__spec__ = None # (!) real value is "ModuleSpec(name='zmq.backend.cython.context', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f3390fbf278>, origin='/usr/lib/python3/dist-packages/zmq/backend/cython/context.cpython-36m-x86_64-linux-gnu.so')"
