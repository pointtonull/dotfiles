...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f33930e7e10>'

__spec__ = None # (!) real value is "ModuleSpec(name='zmq.backend.cython.constants', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f33930e7e10>, origin='/usr/lib/python3/dist-packages/zmq/backend/cython/constants.cpython-36m-x86_64-linux-gnu.so')"
