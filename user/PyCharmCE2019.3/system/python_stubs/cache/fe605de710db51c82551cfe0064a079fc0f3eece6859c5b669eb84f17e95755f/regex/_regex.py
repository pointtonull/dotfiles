# encoding: utf-8
# module regex._regex
# from /usr/local/lib/python3.6/dist-packages/regex/_regex.cpython-36m-x86_64-linux-gnu.so
# by generator 1.147
# no doc
# no imports
...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f3392a19cf8>'

__spec__ = None # (!) real value is "ModuleSpec(name='regex._regex', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f3392a19cf8>, origin='/usr/local/lib/python3.6/dist-packages/regex/_regex.cpython-36m-x86_64-linux-gnu.so')"
